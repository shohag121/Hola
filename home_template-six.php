...
?>
    ...
    <section class="slider-area slider-area-4 bg-white-opacity ptb-200" style="background: rgba(0, 0, 0, 0) url(<?php echo $hola_options['home-slider-bg6']['url']; ?>) repeat scroll center center / cover;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
