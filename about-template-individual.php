				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="about-me-img">
							...
							<img src="<?php echo esc_url($my_image['url']); ?>" alt="<?php echo esc_attr($hola_options['about-me-heading']); ?>" />
                            <?php endif; ?>
						</div>
					</div>
					<div class="col-lg-4 col-md-4 col-sm-6">
						<div class="about-me-info">
							<h2><?php echo $hola_options['about-me-heading']; ?></h2>
							<span><?php echo $hola_options['about-me-designation']; ?></span>
							<p><?php echo $hola_options['about-me-p']; ?></p>
                            <?php if (  $hola_options['about-me-cv']['url'] ) : ?>
							    <a href="<?php echo esc_url( $hola_options['about-me-cv']['url'] ); ?>" class="aboutme-btn">DOWNLOAD RESUME</a>
                            <?php endif; ?>
						</div>
					</div>
