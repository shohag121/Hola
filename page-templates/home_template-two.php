...
?>
    ...
    <section class="slider-area slider-area-2 slider-bg-2 bg-opacity-1 ptb-200"
             style="background-image: <?php echo esc_url( $wpgeeky_options['home-slider-bg2']['url'] ); ?>">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
    ...
    </section><!-- .slider-area .slider-area-2 .slider-bg-2 .bg-opacity-1 .ptb-200 -->
    <!-- slider-section-end -->
...
<?php get_template_part( 'template-parts/progress-counter', 'black' ); ?>

    <!-- portfolio-section-start -->
    <section class="portfolio-area portfolio-area-2 pt-120">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
							...
							?>">
                                <div class="single-portfolio">
                                    <div class="portfolio-img">
										<?php the_post_thumbnail( 'portfolio-img-sqr' ); ?>
                                    </div>
    ...
    </section><!-- .portfolio-area .portfolio-area-2 .pt-120 -->
