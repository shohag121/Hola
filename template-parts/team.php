                    ...
                    <div class="col-lg-3 col-md-3 col-sm-4 col-xs-12">
                        <div class="single-team">
                            <div class="team-img">
                                ...
                                <div class="team-icon">
                                    <a href="<?php echo esc_url( get_post_meta( get_the_ID(), '_hola_team_twitter', 1 ) ); ?>"><i
                                                class="fa fa-twitter"></i></a>
                                    <a href="<?php echo esc_url( get_post_meta( get_the_ID(), '_hola_team_facebook', 1 ) ); ?>"><i
                                                class="fa fa-facebook"></i></a>
                                    <a href="<?php echo esc_url( get_post_meta( get_the_ID(), '_hola_team_linkedin', 1 ) ); ?>"><i
