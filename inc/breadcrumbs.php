...
// Build the breadcrums
		...
		if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
			...
			echo '<li class="item-current item-archive">' . get_the_archive_title() . '</li>';
			...
			// Paginated archives
			echo '<li class="item-current item-current-' . get_query_var('paged') . '">'.__('Page', 'hola') . ' ' . get_query_var('paged') . '</li>';
