	...
	class Wpgeeky_Nav_Walker extends Walker_Nav_Menu {
		...
		public function start_el( &$output, $item, $depth = 0, $args = [], $id = 0 ) {
			...
			if ( 0 === strcasecmp( $item->attr_title, 'divider' ) && 1 === $depth ) {
				...
				$item_output .= ( $args->has_children && 0 === $depth ) ? ' <i class="fa fa-angle-down" aria-hidden="true"></i></a>' : ( ( $args->has_children && 0 < $depth ) ? ' <i class="fa fa-angle-right" aria-hidden="true"></i></a>' : '</a>' );
