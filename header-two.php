...
<!-- header-start -->
<header>
    <div class="header-area header-area-2 default-bg <?php echo esc_attr( $wpgeeky_options['blog-logo-style'] ); ?>">
        <div class="container">
            <div class="row">
                    ...
                    <div class="logo">
					    ...
					    <?php else : ?>
                            <a href="<?php echo esc_url( home_url( '/' ) ); ?>"
                               rel="home"><img
                                        src="<?php echo esc_url( $wpgeeky_options['blog-logo-image-dark']['url'] ); ?>"
